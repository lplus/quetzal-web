...
// }}}
alias ParamsPtr = Params*;


/*
 * Error codes.  Assigned to avoid conflict with EOF and errno(2).
 */
enum FCGX_UNSUPPORTED_VERSION   = -2;
enum FCGX_PROTOCOL_ERROR        = -3;
enum FCGX_PARAMS_ERROR          = -4;
enum FCGX_CALL_SEQ_ERROR        = -5;
...
struct FCGX_Stream 
{
    ...
    alias FillBuffProcFunc = void function(FCGX_Stream*);
    alias EmptyBuffProcFunc = void function(FCGX_Stream* stream, int doClose);
    FillBuffProcFunc fillBuffProc;
    EmptyBuffProcFunc emptyBuffProc;
    void* data;
}
 ...
 */
enum FCGI_FAIL_ACCEPT_ON_INTR	= 1;
